...
By contributing to Ghostly, you assert that:

* The contribution is your own original work.
* You have the right to assign the copyright for the work (it is not owned by your employer, or
  you have been given copyright assignment in writing).
* You [license](https://github.com/patriksvensson/ghostly/blob/main/LICENSE) the contribution under the terms applied to the rest of the Ghostly project.
* You agree to follow the [code of conduct](https://github.com/patriksvensson/ghostly/blob/main/CODE_OF_CONDUCT.md).
...
The assembly `Ghostly` should have no dependencies except the .NET BCL library.
 ...
 * Through GitHub, or through the [GitHub discussions](https://github.com/patriksvensson/ghostly/discussions) (preferred),
   you talk about a feature you would like to see (or a bug), and why it should be in Ghostly.
  ...
  * Once you get a nod from someone in the Ghostly Team, you can start on the feature.
  * Alternatively, if a feature is on the issues list with the
   [Up For Grabs](https://github.com/patriksvensson/ghostly/labels/up-for-grabs) label,
 ...
 * You create, or update, a fork of `patriksvensson/ghostly` under your GitHub account.
 ...
 * Once you feel it is ready, submit the pull request to the `patriksvensson/ghostly` repository against the `main` branch
 ...
 * One of the Ghostly team members, or one of the maintainers, will evaluate it within a
 ...
 * `git fetch upstream` (upstream remote would be `patriksvensson/ghostly`)
 * `git checkout main`
 * `git rebase upstream/main`
 * `git checkout your-branch`
 * `git rebase main`
 * Fix any merge conflicts
 * `git push origin your-branch` (origin would be your GitHub repo or `your-github-username/ghostly` in this case).
...
If you reformat code or hit core functionality without an approval from a person on the Ghostly Team,
...
with permission and was edited to follow Ghostly's conventions and processes.